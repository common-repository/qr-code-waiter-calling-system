 ...
 */
class QRCodeWaiterCallingSystem_Admin {
	...
	private function __construct() {
		 ...
		 *
		 */
		$plugin = QRCodeWaiterCallingSystem::get_instance();
	...
	public function add_plugin_admin_menu() {
		 ...
		 *
		 */
		$page_title = __( 'QR Code Waiter Calling System Plugin Settings', $this->plugin_slug );   
		$menu_title = __( 'QR Code Waiter Calling System', $this->plugin_slug );   
